...
!(function() {
  ...
  try {
    (h.a = document.createElement('span')),
      'undefined' != typeof h.a.addBehavior && h.a.addBehavior('#default#clientCaps');
  } catch (m) {}
  (k = {}),
    (h.jscall = function(a) {
      try {
  ...
  'Gecko' === navigator.product &&
    parseInt(n.substring(n.indexOf('rv:') + 3, n.indexOf(')', n.indexOf('rv:') + 3)).split('.')[0]) <= 2 &&
    window.parm4.jscall();
})(),
  (System = {}),
  (window.System = {
        ...
        (c = a.charCodeAt(d)),
          128 > c
            ...
            : 2048 > c
              ...
              : 65536 > c
                ? (b.push(224 | (c >> 12)), b.push(128 | ((c >> 6) & 63)), b.push(128 | (63 & c)))
                : 2097152 > c
                  ? (b.push(240 | (c >> 18)),
                    b.push(128 | ((c >> 12) & 63)),
                    b.push(128 | ((c >> 6) & 63)),
  ...
  (System.Convert.FromBase64String = function(a, b) {
    ...
    for (
      ...
      (f =
        (c.IA[a.charAt(g++)] << 18) | (c.IA[a.charAt(g++)] << 12) | (c.IA[a.charAt(g++)] << 6) | c.IA[a.charAt(g++)]),
        (n[o++] = f >> 16),
        (n[o++] = (65535 & f) >> 8),
        (n[o++] = 255 & f),
        l > 0 && 19 == ++q && ((g += 2), (q = 0));
  ...
  (System.BigInt._Utils = function() {
    ...
    function g(a, b, c, f) {
      ...
      for (i = g - 1; i >= h; i--) {
        for (
          f[i] == b[h - 1] ? (c[i - h] = C) : (c[i - h] = Math.floor((f[i] * D + f[i - 1]) / b[h - 1]));
          (k = (h > 1 ? b[h - 2] : 0) * c[i - h]),
            (l = k >> B),
            (k &= C),
            (j = l + c[i - h] * b[h - 1]),
            (l = j >> B),
            (j &= C),
            l == f[i] ? (j == f[i - 1] ? k > (i > 1 ? f[i - 2] : 0) : j > f[i - 1]) : l > f[i];
    ...
    function h(a) {
      ...
      for (c = a.length, d = 0, b = 0; c > b; b++)
        (d += a[b]), (e = 0), 0 > d && ((e = -(d >> B)), (d += e * D)), (a[b] = d & C), (d = (d >> B) - e);
    }
    function i(a, b) {
      var c,
        d = 0;
    ...
    function p(a, b) {
      ...
      for (a[0] += b, d = a.length, e = 0, c = 0; d > c; c++)
        if (((e += a[c]), (f = 0), 0 > e && ((f = -(e >> B)), (e += f * D)), (a[c] = e & C), (e = (e >> B) - f), !e))
          return;
    }
    function q(a, b) {
      var c,
    ...
    function s(a, b) {
      ...
      if (b)
        for (d = a.length, e = 0, c = 0; d > c; c++)
          (e += a[c] * b), (f = 0), 0 > e && ((f = -(e >> B)), (e += f * D)), (a[c] = e & C), (e = (e >> B) - f);
    }
    function u(a, b) {
      var c,
        d,
    ...
    function x(a, b, c) {
      var d;
      for (s0.length != 2 * a.length && (s0 = new Array(2 * a.length)), o(s0, 0), d = 0; d < b.length; d++)
        b[d] && v(s0, a, b[d], d);
      w(s0, c), n(a, s0);
    }
    function y(a, b) {
    ...
    function A(a, b, c, d) {
      ...
      for (k = sa.length - 1, e = 0; l > e; e++) {
        for (j = sa[0] + a[e] * b[0], i = ((j & C) * d) & C, h = (j + i * c[0]) >> B, j = a[e], g = 1; m - 4 > g; )
          (h += sa[g] + i * c[g] + j * b[g]),
            (sa[g - 1] = h & C),
            (h >>= B),
            g++,
    ...
    (t = new Array(0)),
      ...
      (this.ToArray = function(a, b) {
        var c,
          d,
          e = new Array();
        if ((s6.length != a.length ? (s6 = m(a)) : n(s6, a), -1 == b)) for (c = 0; c < a.length; c++) e.push(a[c]);
  ...
  (System.Security.Cryptography.ICryptoTransform = function(a, b, c) {
    function d(a, b) {
      var c;
      l
        ? ((c = k.Encrypt(k.Key, a, System.Security.Cryptography.CipherMode.ECB)),
          System.Buffer.BlockCopy(c, 0, b, 0, m))
        : ((c = k.Decrypt(k.Key, a, System.Security.Cryptography.CipherMode.ECB)),
          System.Buffer.BlockCopy(c, 0, b, 0, m));
    }
    function e(a, b) {
      var c = 0;
      ...
      (this._Padding = function(a, b, c) {
        ...
        0 == h.length
          ? (System.Buffer.BlockCopy(a, b, q, 0, c),
            (d > 0 || (0 == d && 2 == g)) && System.Buffer.BlockCopy(f, 0, q, c, e))
  ...
  (System.Security.Cryptography.CipherMode.prototype = { CBC: 1, ECB: 2, OFB: 3, CFB: 4, CTS: 5 }),
  ...
  (System.Security.Cryptography.CryptoStreamMode.prototype = { Read: 0, Write: 1 }),
      ...
      (this.Clone = function(a) {
        ...
        return (
          ...
          a &&
            ...
            this.InverseQ && System.Array.Copy(this.InverseQ, b.InverseQ, this.InverseQ.length),
    ...
    (this.ImportParameters = function(a) {
      ...
      (this.Initialize = function() {
        1 == arguments.length &&
          ...
          ((this.KeySize = arguments[0]), (this.BlockSize = this.KeySize), (this.FeedbackSize = this.KeySize));
      }),
      this.Initialize.apply(this, arguments);
  });
var TCO = new function() {
  (this.loadPubKey = function(a, b) {
    ...
    'sandbox' === a
      ? (d.src = 'https://sandbox.2checkout.com/checkout/api/script/publickey/' + c)
      : (d.src = 'https://www.2checkout.com/checkout/api/script/publickey/' + c),
      (d.onload = d.onreadystatechange = function() {
        (!d.readyState || /loaded|complete/.test(d.readyState)) &&
          ((d.onload = d.onreadystatechange = null),
    ...
    (this.requestToken = function(d, e, g) {
      ...
      if ((h.fillTokenRequest(g, e), b(h, e))) {
        ...
        sellerId = h.sellerId;
        var k = encodeURI(
            '{"sellerId" : "' + sellerId + '", "publicKey" : "' + publishableKey + '" , "userPref" : "' + j + '"}'
          ),
        ...
        l(n, o, p, k) ||
          (k = encodeURI(
            '{"sellerId" : "' + sellerId + '", "publicKey" : "' + publishableKey + '" , "userPref" : ""}'
          )),
          ajax2co({
            url: n,
            type: h.httpMethod,
            ...
            success: function(b, f, g) {
              null !== b.response
                ...
                : null !== b.exception ? c(e, b.exception.errorMsg, b.exception.errorCode) : c(e);
            },
            error: function(a) {
              c(e);
            }
  ...
  var a = function(a, b, d) {
      try {
        ...
        ajax2co({
          ...
          success: function(d, e, f) {
            null !== d.response
              ? a(d, e, f)
              : null !== d.exception ? c(b, d.exception.errorMsg, d.exception.errorCode) : c(b);
          },
          error: function(a) {
            c(b);
          }
    ...
    b = function(a, b) {
      var e = !0;
      return (
        (a.expMonth = 1 === a.expMonth.toString().length ? '0' + a.expMonth : a.expMonth),
        (a.expYear = a.expYear.toString().length < 4 ? '20' + a.expYear : a.expYear),
        (a.cardNum = a.cardNum.replace(/[^0-9]+/g, '')),
        (a.cvv = a.cvv.replace(/[^0-9]+/g, '')),
        d(a.cardNum) && d(a.cvv) && d(a.expMonth) && d(a.expYear)
          ? 'undefined' == typeof publicKey && ((e = !1), c(b, 'Missing publicKey.js', 401))
          : ((e = !1), c(b, 'Missing Card Data', 401)),
        e
      );
    },
    c = function(a, b, c) {
      'undefined' == typeof b && 'undefined' == typeof c && ((b = 'Unable to process the request'), (c = 200)),
    ...
    m = function() {
      (this.tcoUrl = tokenRequestUrl),
        ...
        (this.fillTokenRequest = function(a, b) {
          if ('object' == typeof a)
            a.sellerId && a.publishableKey && a.ccNo && a.expMonth && a.expYear && a.cvv
            ...
            d.sellerId && d.publishableKey && d.ccNo && d.expMonth && d.expYear && d.cvv
