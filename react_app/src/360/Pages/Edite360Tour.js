...
export default function Edite360Tour() {
  ...
  const [transitionDuration, setTransitionDuration] = useState(transitionDurations[0]);
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.place.transitionEffect) {
          ...
          setTransitionDuration(JSON.parse(res.data.place.transitionEffect).duration);
        }
  ...
  const handelSubmit = () => {
    ...
    form.append("transitionEffect", JSON.stringify({type: transitionType, duration: transitionDuration}));
  ...
  const resetAll = (e) => {
    ...
    axios
      .put(`/api/places/${id}`, {
        ...
        openCarousel: false,
        transitionEffect: JSON.stringify({type: transitionTypes[0], duration: transitionDurations[0]})
      })
      .then((res) => {
        console.log(res);
        window.location.reload(true);
              ...
              <div>
                ...
                <Tour>
                  ...
                  {!loading && nadir && rotatioTest ? (
                    ...
                    <Frame image={imageURL.secure_url} zoom={zoom} />
                  )}
              ...
              <div className="bread">
                ...
                <div style={{ display: "inline-block", marginTop: "5px" }}>
                  ...
                  <button
                    ...
                    onClick={() => window.open(`/places/${id}?back=EditTour`, "_blank")}
                  >
