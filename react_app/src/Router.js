...
import ForgotPassword from '../src/360/Pages/ForgotPassword';
...
function Routersecond() {
  ...
  const MyAccount = lazy(() => import('./views/pages/account-settings/AccountSettings.js'));
  ...
  const Home = lazy(() => import('../src/views/dashboard/analytics/AnalyticsDashboard'));
  ...
  const UserProfileId = lazy(() => import('../src/views/pages/profile/ProfileId'));
          ...
          <ContextLayout.Consumer>
            {(context) => {
              let LayoutTag =
                fullLayout === true
                  ? context.fullLayout
                  : context.state.activeLayout === 'horizontal' ? context.horizontalLayout : context.VerticalLayout;
              return (
